...
export type Props = {
  id: string;
  name: string;
  onChange?: (event: React.FormEvent<HTMLInputElement>) => React.FormEvent<HTMLInputElement>;
  onBlur?: (event: React.FormEvent<HTMLInputElement>) => React.FormEvent<HTMLInputElement>;
  label: string;
  errorMessage?: string;
  placeholder: string;
  max?: number;
